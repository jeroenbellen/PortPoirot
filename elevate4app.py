# Code is orignally from https://github.com/barneygale/elevate/blob/master/elevate/posix.py
# I've patched this file to make it work when running from a mac app generated by pyinstaller
import errno
import os
import sys
try:
